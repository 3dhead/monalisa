...
},{"base64-js":1,"ieee754":11,"isarray":12}],3:[function(require,module,exports){
(function (Buffer){
var clone = (function() {
'use strict';
...
},{"./css-keywords":5}],5:[function(require,module,exports){
module.exports = {
...
},{"./conversions":4,"./route":7}],7:[function(require,module,exports){
var conversions = require('./conversions');
...
},{"./conversions":4}],8:[function(require,module,exports){
module.exports = {
	"aliceblue": [240, 248, 255],
	"antiquewhite": [250, 235, 215],
	"aqua": [0, 255, 255],
...
},{"clone":3,"color-convert":6,"color-string":9}],11:[function(require,module,exports){
...
},{"./lib/randgen":14}],14:[function(require,module,exports){
...
var _genetics = require('./genetics');

var _genetics2 = _interopRequireDefault(_genetics);

var _readPixels = require('./read-pixels');

var _readPixels2 = _interopRequireDefault(_readPixels);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var NUM_LAYERS = 5;
var NUM_GENES = 10;
var MUTATION_RATE = 0.95;
var NUM_TRIANGLES = 512;
var MAX_HUE_CHANGE = 5;
var MAX_SATUATION_CHANGE = 0.02;
var MAX_LIGHTNESS_CHANGE = 0.02;
var MAX_POS_CHANGE = 2;
var MAX_ALPHA_CHANGE = 0.02;
var NEW_TRIANGLE_RATE = 0.05;
var TRIANGLE_MUTATION_RATE = 0.005;
var SWAP_RATE = 0.1;
var TOLORATE_SCORE = 5;
...
var randomColor = function randomColor() {
  return (0, _color2.default)({ r: randomInt(0, 256), g: randomInt(0, 256), b: randomInt(0, 256), a: _randgen2.default.rnorm(0.3, 0.1) });
};

var colorDiff = function colorDiff(c1, c2) {
...
source.addEventListener('load', function () {
  ...
  var layers = (0, _pyramid2.default)(source, NUM_LAYERS);
  var usingLayer = 0;

  var randomMovement = function randomMovement(_ref, deviation) {
    var x = _ref.x;
    var y = _ref.y;
    var ratio = layers[usingLayer].ratio;

    return {
      x: x + _randgen2.default.rnorm(0, deviation * ratio),
      y: y + _randgen2.default.rnorm(0, deviation * ratio)
    };
  };

  var newTriangle = function () {
    return function () {
      var origin = { x: random(0, source.width), y: random(0, source.height) };
      return {
        color: randomColor(),
        points: [randomMovement(origin, MAX_POS_CHANGE), randomMovement(origin, MAX_POS_CHANGE), randomMovement(origin, MAX_POS_CHANGE)]
      };
    };
  }();

  var ga = (0, _genetics2.default)({
    numGenes: NUM_GENES,
    gene: function gene() {
      var triangles = new Array(NUM_TRIANGLES);
    ...
    mutate: function () {
      ...
      function (_ref2) {
        ...
        return {
          color: color.clone().rotate(_randgen2.default.rnorm(0, MAX_HUE_CHANGE)),
          points: points
        };
      },
      // change saturation
      function (_ref3) {
        ...
        var satuationChange = _randgen2.default.rnorm(0, MAX_SATUATION_CHANGE);
      ...
      function (_ref4) {
        ...
        var lightnessChange = _randgen2.default.rnorm(0, MAX_LIGHTNESS_CHANGE);
      ...
      function (_ref5) {
        ...
        return {
          color: color.clone().alpha(Math.max(0.15, Math.min(0.6, color.alpha() + _randgen2.default.rnorm(0, MAX_ALPHA_CHANGE)))),
          points: points
        };
      },
      // move p0
      ...
      return function (triangles) {
        ...
        var topLayer = Math.min(0, Math.floor(NUM_TRIANGLES - NUM_TRIANGLES / ratio));
        var idx = randomInt(topLayer, NUM_TRIANGLES);
        if (Math.random() < SWAP_RATE) {
          var _ret = function () {
            var jdx = randomInt(topLayer, NUM_TRIANGLES);
            return {
              v: triangles.map(function (triangle, i) {
                if (i === idx) {
    ...
    evaluate: function () {
      ...
      return function (triangles) {
        var layer = layers[usingLayer];
        var ratio = layer.ratio;

        context.clearRect(0, 0, layer.width, layer.height);
        triangles.forEach(function (_ref9) {
        ...
        var pixels = (0, _readPixels2.default)(context, 0, 0, layer.width, layer.height);
        var score = 0;
  ...
  var numIteration = document.getElementById('num-iteration');
  var currentLayer = document.getElementById('current-layer');
  var bestScore = document.getElementById('best-score');

  var useLayer = function useLayer(nextLayer) {
  ...
  var iterate = function iterate() {
    ...
    ga.bestGene().forEach(function (_ref10) {
...
},{"./genetics":16,"./pyramid":17,"./read-pixels":18,"color":10,"randgen":13}],16:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
var geneSorter = function geneSorter(g1, g2) {
  return g1.score - g2.score;
};

var Genetics = function Genetics(_ref) {
  var numGenes = _ref.numGenes;
  var gene = _ref.gene;
  var mutationRate = _ref.mutationRate;
  var mutate = _ref.mutate;
  var cross = _ref.cross;
  var evaluate = _ref.evaluate;

  var iteration_ = 0;
  var genes_ = new Array(numGenes).fill(null).map(function () {
    var value = gene();
    return { value: value, score: evaluate(value) };
  }).sort(geneSorter);
  ...
  return {
    iterate: function iterate() {
      ...
      genes_ = genes_.concat(genes_.map(function (gene, i) {
        if (Math.random() < mutationRate) {
          var value = mutate(gene.value);
          return { value: value, score: evaluate(value) };
        } else {
          var j = Math.floor(Math.random() * numGenes);
          var _value = cross(gene.value, genes_[j].value);
          return { value: _value, score: evaluate(_value) };
        }
    ...
    reEvaluate: function reEvaluate() {
      genes_ = genes_.map(function (_ref2) {
...
var pyramid = function pyramid(image, numLayers) {
  var canvas = document.createElement('canvas');
  var context = canvas.getContext('2d');
  ...
  for (var i = 0; i < numLayers; i++) {
    ...
    layers[numLayers - i - 1] = {
      ratio: ratio, width: roundWidth, height: roundHeight,
      pixels: (0, _readPixels2.default)(context, 0, 0, roundWidth, roundHeight)
    };
...
},{"./read-pixels":18}],18:[function(require,module,exports){
'use strict';
...
var readPixels = function readPixels(context, dx, dy, width, height) {
  var numPixels = width * height;
  var data = context.getImageData(dx, dy, width, height).data;
  var pixels = new Array(numPixels);
  for (var i = 0; i < numPixels; i++) {
    pixels[i] = (0, _color2.default)({
